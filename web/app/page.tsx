    ...
    <div className="min-h-screen bg-milk selection:bg-accent-green selection:text-milk">
      <nav className="fixed w-full z-50 bg-milk/80 backdrop-blur-xl border-b border-dark-green/5 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center">
          ...
          <div className="hidden md:flex flex-none space-x-8 items-center font-bold text-[10px] uppercase tracking-[0.15em] opacity-70 text-dark-green">
            <a href="info/howto" className="hover:text-accent-green transition">
              Cara Kerja
            </a>
      ...
      <section id="faq" className="py-24 bg-milk">
        <div className="max-w-3xl mx-auto px-6 text-dark-green">
          ...
          <div className="space-y-4">
            {[
              { q: "Apakah dana dicairkan ke rekening bank?", a: "Tidak. Kami menjaga ekosistem tetap aman di blockchain. Dana dicairkan dalam bentuk IDRX langsung ke wallet tujuan." },
              ...
              { q: "Seberapa aman transaksi di platform ini?", a: "Sangat aman. Setiap transaksi dikelola oleh Smart Contract yang telah diaudit, memastikan transparansi mutlak di blockchain." },
            ].map((faq, i) => (
              <details key={i} className="group bg-white p-6 rounded-2xl border border-dark-green/10 cursor-pointer transition-all duration-300 hover:border-dark-green/30">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12 text-dark-green">
          ...
          <div>
            ...
            <ul className="space-y-3 text-[10px] font-bold uppercase tracking-widest text-dark-green/80">
              <li>
                <a href="https://basescan.org" target="_blank" rel="noopener noreferrer" className="hover:text-accent-green transition">
                  Smart Contract
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="https://idrx.gitbook.io/idrx-docs/" target="_blank" rel="noopener noreferrer" className="hover:text-accent-green transition">
                  IDRX Documentation
                </a>
              </li>
            </ul>
