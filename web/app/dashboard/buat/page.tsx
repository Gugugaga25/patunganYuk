      ...
      <div className="bg-white rounded-[2.5rem] p-8 md:p-12 border border-dark-green/5 shadow-sm space-y-10 text-dark-green">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <input 
                ...
                className="w-full bg-milk border border-dark-green/10 rounded-2xl p-4 text-[11px] font-black uppercase tracking-widest outline-none focus:ring-2 focus:ring-accent-green/20" 
              />
            </div>
            <div className="space-y-3">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-milk border border-dark-green/10 rounded-2xl p-4 pl-12 text-[11px] font-black outline-none focus:ring-2 focus:ring-accent-green/20" 
                />
              </div>
            </div>
            <div className="space-y-3">
              ...
              <input 
                ...
                className="w-full bg-milk border border-dark-green/10 rounded-2xl p-4 text-[11px] font-black outline-none focus:ring-2 focus:ring-accent-green/20" 
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 relative z-10">
            <div className="md:col-span-12 space-y-2">
              ...
              <input 
                ...
                className="w-full bg-white border-none rounded-xl p-4 text-[11px] font-black shadow-sm outline-none focus:ring-2 focus:ring-accent-green/20" 
              />
            </div>
          </div>
        </div>
        ...
        <div className="pt-4">
          <button 
            ...
            className="group w-full py-6 bg-dark-green text-milk rounded-full font-black text-xs uppercase tracking-[0.3em] shadow-2xl hover:bg-black transition-all active:scale-[0.98] flex items-center justify-center gap-4 disabled:opacity-60"
          >
          ...
          {isSuccess && (
            <div className="mt-6 p-4 bg-accent-green/10 rounded-2xl text-center border border-accent-green/20">
              <p className="text-[10px] font-black text-accent-green uppercase tracking-widest">
                🎉 Sukses! Patungan diaktifkan & disimpan ke database.
              </p>
            </div>
          )}

          {error && (
            <p className="text-center text-[9px] font-bold text-red-500 uppercase tracking-widest mt-4">
